...
def build_evidence(
    ...
    language: str,
    translated_explicit_ingredients: list[str] | None = None,
) -> DishEvidence:
...
async def analyze_menu(
    ...
    for dish in menu.dishes:
        ...
        evidence = build_evidence(
            dish.canonical_ingredients_en or dish.explicit_ingredients,
            resolution,
            menu.target_language,
            dish.translated_explicit_ingredients,
        )
        ...
        if candidate is not None:
            ...
            enrichment = DishEnrichment(
                ...
                source=(
                    "llm"
                    if resolution.status == DishResolutionStatus.LLM_FALLBACK
                    else "local_fallback"
                ),
